...
<div class="container-fluid bg-sidebar-web position-relative">
    <div class="container bg-split">
        <div class="row">
                ...
                <div class="mb-5 wow zoomIn" data-wow-delay="0.1s">
                    ...
                    <ul class="list-group bg-white border-rounded">
                            <li class="list-group-item border-0 p-3 border-bottom ">
                                <a href="{{ url("$lang/brands/$brandSlug") }}">
                                    <span class="ms-2 fz-13 fw-bold">All Category</span>
                            ...
                            @foreach ($category as $val)
                                <li class="list-group-item border-0 p-3 border-bottom ">
                                    <a href="{{ url("$lang/brands/$brandSlug?search=$search&filterByCategory={$val->slug}") }}" title="{{ ucfirst($val->name) }}" class="text-dark">
            ...
            <div class="col-12 col-sm-9 bg-white my-5 p-5 rounded-4">
                @if(isset($brands))
                ...
                <div class="row align-items-center wow zoomIn" data-wow-delay="0.6s">
                ...
                <form action="{{ url()->current() }}" method="GET" class="mb-3">
                    ...
                    <input type="hidden" name="filterByCategory" value="{{$filterByCategory}}">
                </form>
