      ...
      * {
      ...
      @media (max-width: 480px) {
        ...
        #u_content_text_6 .v-container-padding-padding {
          padding: 30px 65px 10px 20px !important;
        }
																				...
																				<td style="padding: 0px;background-color: transparent;" align="center">
																					<table cellpadding="0" cellspacing="0" border="0" style="width:600px;">
																						<tr style="background-color: transparent;">
																							<![endif]-->
                  <!--[if (mso)|(IE)]>
																							<td align="center" width="600" class="v-col-border" style="background-color: #ffffff;width: 600px;padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;" valign="top">
																								<![endif]-->
                                ...
                                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                  <tr>
                                    <td class="v-text-align" style="padding-right: 0px;padding-left: 0px;" align="center">
                                      <img align="center" border="0" src="{{asset('images/logo.png')}}" alt="image" title="image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 25%;max-width: 145px;" width="145" />
                                    </td>
                                  </tr>
                                </table>
                              </td>
                              ...
                              <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:30px 65px;font-family:arial,helvetica,sans-serif;" align="left">
                                <div class="v-text-align" style="font-size: 14px; line-height: 140%; text-align: left; word-wrap: break-word;">
                                  <p style="line-height: 140%;">
                                    ...
                                    <span style="line-height: 19.6px;">Hello, {{$user['name']}}</span>
                                  </p>
                                  <p style="line-height: 140%;"></p>
                                  <p style="line-height: 140%;">
                                    <span style="line-height: 19.6px;">You has been requested to reset your account password. Please click button below to update your account:</span>
                                  </p>
                                  <p style="line-height: 140%;"></p>
                                </div>
                              </td>
                                ...
                                <div class="v-text-align" align="center">
                                  <!--[if mso]>
																																<v:roundrect
																																	...
																																	xmlns:w="urn:schemas-microsoft-com:office:word" href="https://unlayer.com" style="height:52px; v-text-anchor:middle; width:286px;" arcsize="23%"  stroke="f" fillcolor="#0650A7">
																																	<w:anchorlock/>
																																	<center style="color:#FFFFFF;">
																																		<![endif]-->
                                  <a href="{{@$link}}" target="_blank" class="v-button v-size-width" style="box-sizing: border-box;display: inline-block;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #0650A7; border-radius: 12px;-webkit-border-radius: 12px; -moz-border-radius: 12px; width:auto; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;font-size: 14px;">
                                    <span class="v-padding" style="display:block;padding:10px 100px;line-height:230%;">
                                      <span style="line-height: 32.2px;"></span>
                                      <span  style="line-height: 32.2px;"></span>
                                      <span style="line-height: 32.2px;">Reset Password</span>
                                    </span>
                                  </a>
                                  <!--[if mso]>
																																	</center>
                          ...
                          <tbody>
                            <tr>
                              <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:30px 65px 50px;font-family:arial,helvetica,sans-serif;" align="left">
                                <div class="v-text-align" style="font-size: 14px; line-height: 140%; text-align: left; word-wrap: break-word;">
                                  <p style="line-height: 140%;">
                                    <span data-metadata="&lt;!--(figmeta)eyJmaWxlS2V5IjoialozYzlVTnFJVjFOaDJvYXYxcXFUQyIsInBhc3RlSUQiOjExMTM0NTIxNDUsImRhdGFUeXBlIjoic2NlbmUifQo=(/figmeta)--&gt;" style="line-height: 19.6px;"></span>
                                    <span data-metadata="&lt;!--(figmeta)eyJmaWxlS2V5IjoialozYzlVTnFJVjFOaDJvYXYxcXFUQyIsInBhc3RlSUQiOjEwNTgwMDA0LCJkYXRhVHlwZSI6InNjZW5lIn0K(/figmeta)--&gt;" style="line-height: 19.6px;"></span>
                                    ...
                                    <span style="line-height: 19.6px;">Thank you,  </span>
                                    <span style="line-height: 19.6px;">StickieLink</span>
                                  </p>
                                </div>
                              </td>
                            </tr>
                          ...
                          <tbody>
                            <tr>
                              <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:10px 10px 10px 40px;font-family:arial,helvetica,sans-serif;" align="left">
                                <h4 class="v-text-align" style="margin: 0px; line-height: 140%; text-align: center; word-wrap: break-word; font-size: 12px; font-weight: 700;">This message is automated sent by system. Please do not reply.</h4>
                              </td>
                            </tr>
                          </tbody>
                        </table>
                    ...
                    <div style="background-color: #ffffff;height: 100%;width: 100% !important;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;">
                      ...
                      <div class="v-col-border" style="box-sizing: border-box; height: 100%; padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;">
                        ...
                        <table id="u_content_text_13" style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                          <tbody>
                            <tr>
                              <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:0px 0px 10px 20px;font-family:arial,helvetica,sans-serif;" align="left">
                                <div class="v-text-align" style="font-size: 12px; color: #727272; line-height: 250%; text-align: center; word-wrap: break-word;">
                                  <p style="line-height: 250%;">StickieLink powered by SmartStickies @ 2024</p>
                                </div>
                              </td>
                            </tr>
                          </tbody>
