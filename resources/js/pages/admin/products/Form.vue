      ...
      <div class="col-12">
        <card-form :title="'Add Product'">
          ...
          <div class="row align-items-center mt-4">
            ...
            <div class="col-lg-4 col-12">
              <input class="form-control" v-model="params.code" required>
            </div>
          </div>
          <div class="row align-items-center mt-4">
            <div class="col-lg-2 col-12">
            ...
            <card-page>
              <div class="row">
                <div class="col-12 col-lg-12">
                  <label>Specification ID <span class="text-danger">*</span></label>
                </div>
                <div class="col-12 col-lg-12">
                  <CKEditor4
                    v-model="params.specification_id"
                    :config="editorConfig"
                  />
                </div>
              </div>
              <div class="row mt-4">
                <div class="col-12 col-lg-12">
                  <label>Specification EN <span class="text-danger">*</span></label>
                </div>
                <div class="col-12 col-lg-12">
                  <CKEditor4
                    v-model="params.specification_en"
                    :config="editorConfig"
                  />
                </div>
              </div>
