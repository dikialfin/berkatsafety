<template>
  <div class="modal fade" id="bulk-delete-modal" tabindex="-1" role="dialog" aria-hidden="true" style="backdrop-filter: blur(1px);">
...
export default {
  ...
  methods:{
    submit(){
      this.loading = true
      axios.post(`${this.delete_url}`,{...this.param}).then(res => {
        this.loading = false
