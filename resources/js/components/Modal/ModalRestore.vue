<template>
  <div class="modal fade" id="restore-modal" tabindex="-1" role="dialog" aria-hidden="true" style="backdrop-filter: blur(1px);">
...
export default {
  ...
  methods:{
    submit(){
      this.loading = true
      axios.get(`${this.$store.getters.restore_data.restore_url}`).then(res => {
        this.loading = false
        this.$root.toast('Data Restored!','success')
