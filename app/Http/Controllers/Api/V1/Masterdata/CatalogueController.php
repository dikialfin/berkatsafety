...
use App\Models\{BrandsCatalogue, Catalogue};
...
class CatalogueController extends Controller
{
    ...
    public function add(Request $request)
    {
        ...
        try {
            ...
            if ($request->id) {
                Catalogue::where('id', $request->id)->update($data);
                $catad = $request->id;
            } else {
            ...
            // create brand
            BrandsCatalogue::where('catalog_id', $catad)->delete();
            foreach($request->brand_id as $val) {
                BrandsCatalogue::insert([
                    'catalog_id' => $catad,
                    'brand_id' => $val,
    ...
    {
        $data = Catalogue::with(['brands:id'])->where('id', $id)->first();
